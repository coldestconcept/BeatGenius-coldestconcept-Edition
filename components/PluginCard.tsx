  ...
  return (
    <div className="bg-white/20 backdrop-blur-xl border border-white/30 rounded-[1.5rem] p-4 shadow-sm hover:bg-white/40 hover:scale-[1.02] transition-all">
      <div className="flex justify-between items-start mb-2">
        <span className="text-[10px] font-black uppercase tracking-widest text-[#4a5f5a]">
          {plugin.vendor}
        </span>
      ...
      <h3 className="text-sm font-bold truncate text-[#2c3e3a]">
        {plugin.name}
      </h3>
      <div className="mt-4 flex items-center justify-between text-[9px] font-bold uppercase tracking-wider text-[#4a5f5a]/60">
